...
st.markdown("This is not a source of legal advice, this is a chatbot trying its best to help. Lawyers are expensive and intimidating, so it might help to talk it through without judgement or pressure")